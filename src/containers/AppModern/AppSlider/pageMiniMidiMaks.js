...
import { appMinimidimask } from "common/data/AppModern/minimidimask";
import Fade from "react-reveal/Fade";

const AppMinimidiMask = () => {
  const { title, description, features, carousel } = appMinimidimask;
...
export default AppMinimidiMask;
